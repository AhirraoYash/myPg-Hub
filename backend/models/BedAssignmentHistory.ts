...
export const BedAssignmentHistory: Model<IBedAssignmentHistory> =
  (mongoose.models.BedAssignmentHistory as Model<IBedAssignmentHistory>) ||
  mongoose.model<IBedAssignmentHistory>('BedAssignmentHistory', BedAssignmentHistorySchema);
